...
* @param Virologist v
*/
    public void StealGear(Virologist v)
    {
...
*/
    public void ReceiveGeneticCode(Agent geneticCode)
    {
        ...
        if(!this.HasThisAgent(geneticCode))
            this.LearnGeneticCode(geneticCode);
...
*/
    public void MaterialPickedUp(String material, int amount)
    {
        ...
        if (material.equals("aminosav")){
            this.amountAminoacid= Math.min(amountAminoacid + amount, maxAmount);
        }
